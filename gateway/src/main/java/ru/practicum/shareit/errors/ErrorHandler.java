...
public class ErrorHandler {
    ...
    public ErrorResponse duplicateError(final DuplicateException e) {
    ...
    public ErrorResponse handleObjectException(final BadRequestException e) {
    ...
    public ErrorResponse handleIdException(final NotFoundException e) {
